...
links_data <- read_csv("C:/Github Repos/data-science-tutorial/Lab Test 2 Prep/src/palo.csv", show_col_types = FALSE)[]
...
# Save to CSV
write_csv(results, "C:/Github Repos/data-science-tutorial/Lab Test 2 Prep/src/palo_text.csv")

cat("✅ Saved scraped articles with text to palo_text.csv\n")
