...
links_data <- read_csv("C:/Github Repos/data-science-tutorial/Scrappings/cnn_links_with_labels.csv", show_col_types = FALSE)[]
...
# Save to CSV
write_csv(results, "C:/Github Repos/data-science-tutorial/Scrappings/cnn2_articles_with_text.csv")

cat("Saved scraped articles with text!\n")
