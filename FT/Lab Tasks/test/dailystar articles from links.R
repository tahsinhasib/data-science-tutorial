...
links_data <- read_csv("C:/Github Repos/data-science-tutorial/FT/Lab Tasks/test/saved/dailystar_links_with_labels.csv", show_col_types = FALSE)[]
...
# Save to CSV
write_csv(results, "C:/Github Repos/data-science-tutorial/FT/Lab Tasks/test/saved/dailystar_articles_with_text.csv")
