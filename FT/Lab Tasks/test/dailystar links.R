...
# Save to CSV
write_csv(links_data, "C:/Github Repos/data-science-tutorial/FT/Lab Tasks/test/saved/dailystar_links_with_labels.csv")

cat("Saved", nrow(links_data), "links with aria-labels to dailystar_links_with_labels.csv\n")
