...
png("C:/Github Repos/data-science-tutorial/FT/Lab Tasks/test/saved/wordcloud.png", width = 1000, height = 800)
...
cat("✅ Word cloud saved to C:/Github Repos/data-science-tutorial/FT/Lab Tasks/test/saved/wordcloud.png\n")
